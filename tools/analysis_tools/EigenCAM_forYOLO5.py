...
im = Image.fromarray(np.hstack((rgb_img, cam_image, renormalized_cam_image)))
im.save("/hotdata/userdata/sarah.laroui/workspace/mmdetection/explainable_results/test_eigenCAM.jpg")
