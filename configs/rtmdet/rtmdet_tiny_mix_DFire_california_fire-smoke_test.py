_base_ = [
    ...
    '../_base_/datasets/mix_DFire_california_fire-smoke_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection_private/workdir/finetune_mix_DFire_california/from_coco_rtmdet_tiny_syncbn_fast_4xb8-lr0.0005-100e_fire-smoke/best_coco/bbox_mAP_epoch_95.pth"
method = 'from_mix_DFire_california'
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection_private/workdir/test_paratronic/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-lr{base_lr}-{max_epochs}e_smoke"
