_base_ = [
    ...
    '../_base_/datasets/person_NII_CU_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----

checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_person_NII_CU/new_from_scratch_real_size_img_rtmdet_tiny_syncbn_fast_10xb4-100e_person_NII_CU/best_coco/bbox_mAP_epoch_100.pth"
fold_test = "from_scratch_2688x1952_img_"
...
work_dir = "/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/test_person_NII_CU/" + fold_test + f"rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_person_NII_CU"
