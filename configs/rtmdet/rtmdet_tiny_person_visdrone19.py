_base_ = [
    ...
    '../_base_/datasets/visdrone19-person_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
...
work_dir = f"/home/sarah.laroui/workspace/bfte/mmdetection/workdir/finetune_person_visdrone19/{ssl_method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_person_visdrone19"
