...
# ==============Custom Variables==============
# -----runtime related-----
checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection_private/workdir/finetune_fire-smoke_DFire/from_imagenet_rtmdet_tiny_syncbn_fast_4xb8-lr0.0005-100e_fire-smoke/best_coco/bbox_mAP_epoch_94.pth"
method = 'from_DFire_coco_with_1332bkg'
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection_private/workdir/test_paratronic/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-lr{base_lr}-{max_epochs}e_fire-smoke"
