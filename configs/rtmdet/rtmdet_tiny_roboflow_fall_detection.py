...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection_private//workdir/finetune_roboflow_fall/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_fallen_person_azuria"
