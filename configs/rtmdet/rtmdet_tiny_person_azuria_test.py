_base_ = [
    ...
    '../_base_/datasets/azuria-person_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----

checkpoint = "/home/sarah.laroui/workspace/bfte/mmdetection/workdir/finetune_person_azuria/coco_pretrain_freeze1_rtmdet_tiny_syncbn_fast_10xb4-3000e_fallen_person_azuria/best_coco/bbox_mAP_epoch_206.pth"
...
work_dir = f"/home/sarah.laroui/workspace/bfte/mmdetection/workdir/test_azuria-person/rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_person_detection"
