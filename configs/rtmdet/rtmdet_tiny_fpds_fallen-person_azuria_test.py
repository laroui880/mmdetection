_base_ = [
    ...
    '../_base_/datasets/mix_FPDS_azuria-irt_fallen_person_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_mix_fpds_fallen_person_azuria/from_coco_freeze4_aug_rtmdet_tiny_syncbn_fast_4xb4-lr0.0005-1000e_fall_person/best_coco/bbox_mAP_epoch_426.pth"
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/test_mix_fpds_fallen_person_azuria/rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-lr{base_lr}-{max_epochs}e_fall_person"
