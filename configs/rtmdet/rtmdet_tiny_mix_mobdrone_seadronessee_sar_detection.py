_base_ = [
    ...
    '../_base_/datasets/mix_mobdrone_seadronessee_sar_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection_private/workdir/finetune_mix_mobdrone_seadronessee_sar/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-lr{base_lr}-{max_epochs}e_fire-smoke"
