_base_ = [
    ...
    '../_base_/datasets/force06_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
...
ssl_method = 'swav_patternnet_smk'
...
work_dir = f"/home/sarah.laroui/workspace/bfte/mmdetection/workdir/finetune_force06/{ssl_method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_force06"
