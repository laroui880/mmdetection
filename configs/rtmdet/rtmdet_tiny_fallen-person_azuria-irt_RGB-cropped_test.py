...
# ==============Custom Variables==============
# -----runtime related-----
checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_fallen_person_azuria_irt_RGB-cropped/from_coco_rtmdet_tiny_syncbn_fast_4xb8-100e_person-fall_azuria/best_coco/bbox_mAP_epoch_97.pth"
method = 'from_coco_finetuned_azuria'
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/test_fallen_person_azuria_irt_RGB-cropped/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_person-fall_azuria"
