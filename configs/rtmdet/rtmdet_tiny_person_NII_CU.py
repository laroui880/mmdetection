...
# checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmselfsup/work_dirs/selfsup/swav_cspnext_8xb32-mcrop-2-6-coslr-1000e_nii_cu_rgb-224-96/epoch_1000.pth"
ssl_method = 'real_size_archP6'
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_person_NII_CU/{ssl_method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_person_NII_CU"
...
model = dict(
    ...
    neck=dict(
        type='CSPNeXtPAFPN',
        in_channels=[96, 192, channels], #288 #384
        out_channels=96,
        num_csp_blocks=1,
        expand_ratio=0.5,
        norm_cfg=norm_cfg,
