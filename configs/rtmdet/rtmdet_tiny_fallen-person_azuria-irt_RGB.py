_base_ = [
    ...
    '../_base_/datasets/azuria-irt_fallen_person_RGB_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_fallen_person_azuria_irt/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-lr{base_lr}-{max_epochs}e_person_NII_CU"
