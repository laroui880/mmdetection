_base_ = [
    ...
    '../_base_/datasets/mix_azuria-roboflow_fallen_person_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----

checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection_private/workdir/finetune_mix_azuria_roboflow_fallen-person_person/from_coco_rtmdet_tiny_syncbn_fast_4xb8-100e_fallen_person_azuria/best_coco/bbox_mAP_epoch_82.pth"
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection_private//workdir/test_mix_azuria_roboflow_fallen-person_person/rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_fallen_person_azuria"
