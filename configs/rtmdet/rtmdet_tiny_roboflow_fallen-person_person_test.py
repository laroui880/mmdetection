_base_ = [
    ...
    '../_base_/datasets/roboflow-fallen_person-person_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
...
work_dir = f"/home/sarah.laroui/workspace/bfte/mmdetection/workdir/test_azuria_fallen-person_person/roboflow_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_fallen_person_azuria"
