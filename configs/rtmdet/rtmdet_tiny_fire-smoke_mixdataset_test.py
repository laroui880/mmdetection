_base_ = [
    ...
    '../_base_/datasets/mix_Dfire_fire-smoke_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_mixDataset_fire-smoke/from_coco_rtmdet_tiny_syncbn_fast_4xb8-lr0.0005-100e_fire-smoke/best_coco/bbox_mAP_epoch_98.pth"
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/test_mixDataset_fire-smoke/rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-lr{base_lr}-{max_epochs}e_fire-smoke"
