_base_ = [
    ...
    '../_base_/datasets/azuria_merge-ship-fallenp-person_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----

checkpoint = "/home/sarah.laroui/workspace/bfte/mmdetection/workdir/finetune_azuria_merge-ship-fallenp-person/coco_pretrain_freeze_rtmdet_tiny_syncbn_fast_10xb32-1000e_ship_detection/best_coco/bbox_mAP_epoch_999.pth"
method = 'coco'
...
work_dir = f"/home/sarah.laroui/workspace/bfte/mmdetection/workdir/test_azuria_merge-ship-fallenp-person/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_ship_detection"
