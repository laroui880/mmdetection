...
checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/W_from_3_to_4channels/coco/rtmdet_tiny_syncbn_fast_8xb32-300e_coco_20230102_140117-dbb1dc83.pth"
ssl_method = 'from_scratch'  # swav_azuria-irt_rgbir_freeze1'
...
max_epochs = 100
stage2_num_epochs = 20 #8 for 50 epochs
base_lr = 0.0005#4
interval = 10
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_fallen-person_azuria-irt_RGB-IR/{ssl_method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{base_lr}-{max_epochs}e_fall_person_azuria"
