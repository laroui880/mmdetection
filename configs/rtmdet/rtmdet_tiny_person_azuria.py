...
ssl_method = 'coco_pretrain_freeze1'
...
work_dir = f"/home/sarah.laroui/workspace/bfte/mmdetection/workdir/finetune_person_azuria/{ssl_method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_fallen_person_azuria"
