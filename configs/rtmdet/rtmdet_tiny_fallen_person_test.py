_base_ = [
    ...
    '../_base_/datasets/fallen_person_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----

checkpoint = "/home/sarah.laroui/workspace/bfte/mmdetection/workdir/finetune_fallen_person/SSL_mix_patternnet_wildfire_finetuneForce06_35imgs/best_coco/bbox_mAP_epoch_99.pth"
...
work_dir = f"/home/sarah.laroui/workspace/bfte/mmdetection/workdir/test_fallen_person/rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_fallen_person"
