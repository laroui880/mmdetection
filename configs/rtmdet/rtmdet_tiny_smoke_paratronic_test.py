...
# ==============Custom Variables==============
# -----runtime related-----
checkpoint = '/hotdata/userdata/sarah.laroui/workspace/mmdetection_private/workdir/finetune_smoke_paratronic/from_DFire_coco_freeze1_rtmdet_tiny_syncbn_fast_4xb4-lr0.0005-50e_fire-smoke/best_coco/bbox_mAP_epoch_47.pth'  # noqa
method = 'finetuned_paratronic_from_DFire_coco'
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection_private/workdir/test_smoke_paratronic/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-lr{base_lr}-{max_epochs}e_smoke"
