_base_ = [
    ...
    '../_base_/datasets/azuria-irt_fallen_person_IR_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_fallen_person_azuria_irt_IR/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_person_azuria_irt_ir"
