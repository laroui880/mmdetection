_base_ = [
    ...
    '../_base_/datasets/smoke_paratronic_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
#checkpoint = '/hotdata/userdata/sarah.laroui/workspace/mmdetection_private/workdir/finetune_fire-smoke_DFire/from_coco_rtmdet_tiny_syncbn_fast_4xb8-lr0.0005-100e_fire-smoke/best_coco/bbox_mAP_epoch_92.pth'  # noqa
...
checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_mix_DFire_california/from_coco_rtmdet_tiny_syncbn_fast_4xb8-lr0.0005-100e_fire-smoke/best_coco/bbox_mAP_epoch_95.pth"
method = 'from_mixDFireCalifornia_coco_tosup'
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_smoke_paratronic/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-lr{base_lr}-{max_epochs}e_fire-smoke"
