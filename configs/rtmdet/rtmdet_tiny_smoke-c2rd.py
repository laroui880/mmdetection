_base_ = [
    ...
    '../_base_/datasets/smoke-c2rd_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_fire-smoke_DFire/from_coco_rtmdet_tiny_syncbn_fast_4xb8-lr0.0005-100e_fire-smoke/best_coco/bbox_mAP_epoch_92.pth"
method = 'from_DFire'
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_smoke-c2rd/{method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_smoke-c2rd"
