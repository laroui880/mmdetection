_base_ = [
    ...
    '../_base_/datasets/person_NII_CU_Fused_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
...
#checkpoint = "/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_person_NII_CU_Fused/from_scratch_resize2688x1952_rtmdet_tiny_syncbn_fast_10xb4-100e_person_NII_CU/best_coco/bbox_mAP_epoch_98.pth"
ssl_method = 'from_scratch_resize2688x1952'
...
work_dir = f"/hotdata/userdata/sarah.laroui/workspace/mmdetection/workdir/finetune_person_NII_CU_Fused/{ssl_method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_person_NII_CU"
