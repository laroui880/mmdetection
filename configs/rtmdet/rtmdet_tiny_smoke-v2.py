_base_ = [
    ...
    '../_base_/datasets/smoke-v2_detection.py', './rtmdet_tta.py'
]
# ==============Custom Variables==============
# -----runtime related-----
#checkpoint = '/home/sarah.laroui/workspace/bfte/mmselfsup/work_dirs/selfsup/mocov3_cspnext_8xb512-amp-coslr-100e_smk/epoch_300.pth'
#checkpoint = '/home/sarah.laroui/workspace/bfte/mmselfsup/work_dirs/selfsup/mocov3_cspnext_8xb512-amp-coslr-800e_resisc45/epoch_800.pth'
#checkpoint = "/home/sarah.laroui/workspace/bfte/mmselfsup/work_dirs/selfsup/swav_cspnext_8xb64-mcrop-2-6-coslr-1000e_resisc45-224-96/epoch_1000.pth"
...
ssl_method = 'swav_mixdata_patternnet_wildfire'
...
work_dir = f"/home/sarah.laroui/workspace/bfte/mmdetection/workdir/finetune_smoke-v2/{ssl_method}_rtmdet_tiny_syncbn_fast_{num_workers}xb{batch_size}-{max_epochs}e_smoke-v2"
